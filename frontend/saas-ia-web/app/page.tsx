    ...
    <main className="min-h-screen overflow-hidden bg-[#05060b] text-white">
      <div className="relative isolate">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-1/2 top-[-14rem] h-[30rem] w-[30rem] -translate-x-1/2 rounded-full bg-fuchsia-500/16 blur-[150px]" />
          <div className="absolute right-[-8rem] top-[6rem] h-[26rem] w-[26rem] rounded-full bg-violet-500/18 blur-[140px]" />
          <div className="absolute left-[-10rem] top-[18rem] h-[24rem] w-[24rem] rounded-full bg-cyan-400/10 blur-[130px]" />
          <div className="absolute inset-x-0 top-0 h-[42rem] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),transparent_34%)]" />
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 py-4 sm:px-6 lg:px-8">
          <div className="rounded-[34px] border border-white/8 bg-[rgba(7,8,15,0.82)] shadow-[0_30px_140px_rgba(0,0,0,0.58)] backdrop-blur-2xl">
            <header className="flex flex-col gap-5 border-b border-white/8 px-5 py-5 md:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10">
              ...
              <nav className="flex flex-wrap items-center gap-2 rounded-full border border-white/8 bg-white/[0.03] p-1.5">
                {['Platform', 'Modules', 'Architecture', 'Security'].map((item) => (
                  <span
                    key={item}
                    className="rounded-full px-4 py-2 text-sm text-zinc-300 hover:bg-white/[0.04] hover:text-white"
                  >
                    {item}
                  </span>
                ))}
            ...
            <section className="relative px-5 pb-8 pt-10 md:px-8 lg:px-10 lg:pb-10 lg:pt-14">
              <div className="grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(480px,0.95fr)] lg:items-start">
                <div className="max-w-[760px]">
                  ...
                  <h1 className="mt-8 max-w-[900px] text-[3.2rem] font-semibold leading-[0.95] tracking-[-0.075em] text-white md:text-[5rem] xl:text-[6.25rem]">
                    Direct finance,
                    <br />
                  ...
                  <div className="mt-8 grid max-w-[860px] gap-5 md:grid-cols-[minmax(0,1fr)_280px]">
                    ...
                    <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                  ...
                  <div className="mt-10 flex flex-wrap gap-4">
                    <Link
                      href="/login"
                      className="rounded-full bg-[linear-gradient(135deg,#fbf7ff,#d1bcff_42%,#8a5cff)] px-7 py-4 text-sm font-semibold text-[#120817] shadow-[0_16px_60px_rgba(163,121,255,0.32)]"
                    >
                      Enter platform
                    </Link>
                    <Link
                ...
                <div className="relative mx-auto w-full max-w-[620px] lg:max-w-none">
                  <div className="absolute left-1/2 top-12 h-[16rem] w-[16rem] -translate-x-1/2 rounded-full bg-violet-500/18 blur-[120px]" />
                  ...
                  <div className="relative rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(19,20,33,0.88),rgba(7,8,15,0.92))] p-4 shadow-[0_24px_120px_rgba(0,0,0,0.55)]">
                    <div className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(12,14,24,0.96),rgba(7,9,16,0.98))] p-4">
                      ...
                      <div className="mt-4 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
                        <div className="rounded-[26px] border border-white/8 bg-[radial-gradient(circle_at_top,rgba(175,131,255,0.16),transparent_42%),linear-gradient(180deg,rgba(17,18,30,0.98),rgba(11,13,21,0.98))] p-5">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="rounded-[24px] border border-white/8 bg-[linear-gradient(160deg,rgba(15,77,70,0.58),rgba(9,15,18,0.96))] p-4">
                    ...
                    <div className="mt-4 grid gap-4 md:grid-cols-[0.9fr_1.1fr]">
                      ...
                      <div className="rounded-[26px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-5">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-xs uppercase tracking-[0.28em] text-zinc-500">
                              Operations radar
                        ...
                        <div className="mt-8 grid gap-4 sm:grid-cols-3">
                          {[
                            ...
                            <div
                              key={label}
                              className="rounded-[22px] border border-white/8 bg-black/20 px-4 py-5"
                            >
                              <p className="text-3xl font-semibold tracking-[-0.06em] text-white">
                                {value}
                              </p>
