        ...
        <section className="relative flex min-w-0 flex-1 overflow-hidden">
          <div className="dashboard-scroll min-w-0 flex-1 overflow-y-auto overflow-x-hidden">
            <div className="px-4 py-4 md:px-6 xl:px-8">
              <header className="mb-5 flex flex-wrap items-start justify-between gap-4 rounded-[24px] border border-white/8 bg-white/[0.03] px-5 py-4">
                <div className="min-w-0">
                  <div className="mb-2 flex flex-wrap items-center gap-3">
                    <span className="text-[10px] uppercase tracking-[0.3em] text-violet-200/60">Workspace</span>
                    <span className="inline-flex rounded-full border border-violet-400/14 bg-violet-500/8 px-3 py-1 text-[10px] uppercase tracking-[0.22em] text-violet-100/70">
                      Tempo real
                    </span>
                  </div>
                  <h1 className="text-[2rem] font-semibold tracking-tight text-white">{pageTitle}</h1>
                ...
                <div className="flex items-center gap-3 self-start">
                  <button
                    ...
                    className="hidden rounded-[16px] border border-violet-300/16 bg-violet-500/10 px-4 py-2.5 text-sm font-medium text-white transition hover:border-violet-300/26 hover:bg-violet-500/15 xl:inline-flex"
                  >
                    IA
                  </button>
                  ...
                  <button
                    onClick={logout}
                    className="rounded-[16px] border border-white/10 bg-white px-4 py-2.5 text-sm font-medium text-black transition hover:bg-zinc-200"
                  >
                    Logout
                  </button>
                </div>
