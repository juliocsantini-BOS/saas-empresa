              ...
              <header className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-[20px] border border-white/8 bg-white/[0.03] px-4 py-3">
                ...
                <div className="flex items-center gap-2 self-start">
                  <button
                    ...
                    className="hidden rounded-[14px] border border-violet-300/16 bg-violet-500/10 px-3.5 py-2 text-sm font-medium text-white transition hover:border-violet-300/26 hover:bg-violet-500/15 xl:inline-flex"
                  >
                    IA
                  </button>
                  ...
                  <button
                    onClick={logout}
                    className="rounded-[14px] border border-white/10 bg-white px-3.5 py-2 text-sm font-medium text-black transition hover:bg-zinc-200"
                  >
                    Logout
                  </button>
                </div>
